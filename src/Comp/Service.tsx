      ...
      <div className="w-full h-auto mt-10 flex gap-8 items-center">
        ...
        <div className="w-full p-5 flex flex-col gap-8">
          {services.map((service, index) => (
            <div
              ...
              className="service-box backdrop-blur-lg bg-[#2d4122]/90 border border-white/50  flex items-center gap-6 p-5 rounded-lg shadow-lg hover:shadow-xl transition-shadow text-white h-[25vh]"
            >
        ...
        <div className="w-full flex justify-center items-center">
          <img
            ...
            src="/farm2.jpg"
            alt="Farm Services"
            className="w-[100%] h-[80%]  object-cover rounded-xl shadow-lg border border-gray-300"
          />
        </div>
